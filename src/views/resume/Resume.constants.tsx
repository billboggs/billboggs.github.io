...
export const RESUME_ITEMS: ResumeItem[] = [
  ...
  },
  {
    ...
    highlights: [
      'Tech Lead for the HPE AI at Scale Managed Services Team, drove the development and delivery of enterprise-scale AI solutions.',
      'Designed and built a SaaS product leveraging Determined.ai and Pachyderm in AWS and GCP, which enabled scalable and efficient AI workflows.',
  ...
  },
  {
    ...
    highlights: [
      ...
      'Set up CI/CD pipelines for multiple companies.',
    ],
  },
  {
    id: 5,
    ...
    highlights: [
      ...
      'Led multiple Azure Function Apps in .NET core.',
